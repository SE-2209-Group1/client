...
const GradProfileForm = ({ profileData }) => {
    return (
        <>
            {!(profileData && profileData.length > 0) ? (<div role="status">
                ...
                <Card key={data.profileid} header={"Edit Your Profile"}>
                    <form>
                        <Divider gray={true}>
                            <dt className="text-sm font-medium text-gray-500">Full name:</dt>
                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                <input className="bg-white p-2 hover:border-2 " placeholder={data.name} />
                            </dd>
                        </Divider>
                        ...
                        <Divider>
                            ...
                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                <input className="bg-white p-2 hover:border-2 " placeholder={data.personalemail} />
                            </dd>
                        </Divider>
                        ...
                        <Divider gray={true}>
                            ...
                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                <input className="bg-white p-2 hover:border-2 " placeholder={data.workemail} />
                            </dd>
                        </Divider>
                        ...
                        <Divider>
                            ...
                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                <input className="bg-white p-2 hover:border-2 " placeholder={data.phoneno} />
                            </dd>
                        </Divider>
                        ...
                        <Divider gray={true}>
                            ...
                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                <input className="bg-white p-2 hover:border-2 " placeholder={data.gender} />
                            </dd>
                        </Divider>
                        ...
                        <Divider>
                            ...
                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                <input className="bg-white p-2 hover:border-2 " placeholder={data.nationality} />
                            </dd>
                        </Divider>
                        ...
                        <Divider gray={true}>
                            ...
                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                <input className="bg-white p-2 hover:border-2 " placeholder={data.personality} />
                            </dd>
                        </Divider>
