...
const YourInformation = ({ profileData }) => {
    return (
        <>
            {!(profileData && profileData.length > 0) ? (<div role="status">
                ...
                <Card key={data.profileid} header={"Your Information"}>
                    <Divider gray={true} wideDivider={true}>
                        ...
                        <dd className="flex mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0 ">
                            <img className='h-32' src='https://education.oracle.com/file/general/Oracle-Explorer-Badge.png' alt="badge" />
                            <img className='h-32 ml-4' src='https://images.credly.com/images/89e728ec-27f8-49ce-a8ea-2df7768f9594/Agile_Explorer.png' alt="badge" />
                        </dd>
                    </Divider>

                    <Divider wideDivider={true}>
                        <dt className="text-sm font-medium text-gray-500">Scores:</dt>
                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                            {/* Will have to map data in the future */}
                            <p>Aptitude: 54%</p>
                            <p>Java: 1%</p>
                            <p>JavaScript: 10%</p>
                            <p>React: 4%</p>
