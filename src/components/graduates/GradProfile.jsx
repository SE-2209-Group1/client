...
const GradProfile = ({ fullName, personalEmail, workEmail, phoneNum, gender, nationality, personality, githubLink, linkedinLink }) => {
                    ...
                    <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
                        ...
                        <ul className="mt-2 text-gray-700">
                            ...
                            <li className="flex border-b py-2">
                                ...
                                <span className="text-gray-700">{personalEmail}</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">Work Email:</span>
                                <span className="text-gray-700">{workEmail}</span>
                            </li>
                            <li className="flex border-b py-2">
