                    ...
                    <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
                        ...
                        <ul className="mt-2 text-gray-700">
                            <li className="flex border-y py-2">
                                ...
                                <span className="text-gray-700">{ profiledata[0].name}</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">Email:</span>
                                <span className="text-gray-700">{ profiledata[0].personalemail}</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">Work Email:</span>
                                <span className="text-gray-700">{ profiledata[0].workemail}</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">Mobile:</span>
                                <span className="text-gray-700">{profiledata[0].phoneno }</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">Gender:</span>
                                <span className="text-gray-700">{ profiledata[0].gender}</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">Nationality:</span>
                                <span className="text-gray-700">{ profiledata[0].nationality}</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">Personality:</span>
                                <span className="text-gray-700">{ profiledata[0].personality}</span>
                            </li>
                            <li className="flex items-center border-b py-2 space-x-2">
                                <span className="font-bold w-24">Elsewhere:</span>
                                <a href={ profiledata[0].linkedinlink } title="LinkedIn">
                                ...
                                <a href="{ profiledata[0].githublink } " title="Github">
